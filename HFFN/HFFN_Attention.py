...
x_train_s = x_train_s / 255.0;  x_test_s = x_test_s / 255.0
...
for model_name in models_to_test:
    print(f"\n{'='*60}\nHFFN Attention KFold — {model_name}\n{'='*60}")
    ...
    for train_idx, val_idx in kf.split(x_all):
        ...
        save_path = os.path.join(MODEL_SAVE_DIR, f'HFFN_Attn_{model_name}_fold{fold_no}.h5')
        ...
        print(f"\n  Results — HFFN Attention {model_name} Fold {fold_no}:")
